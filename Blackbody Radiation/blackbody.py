...
print(popt[1])
print(pstd[1])
chi2 = reduced_chi_squared(temperature, wavelength, f(temperature, *popt), temp_unc, 2)
...
print(popt[1])
print(pstd[1])
chi2 = reduced_chi_squared(temperature, area_curve, f2(temperature, *popt), temp_unc, 2)
print('Reduced Chi Squared:', chi2)
