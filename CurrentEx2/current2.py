...
# Plot residuals
plt.title('Residuals from Current over Voltage')
plt.axhline(color='grey', linestyle='--')
plt.errorbar(voltage, current - model(voltage, *popt), yerr=uncertainty_I, marker='o', ls='', lw=3, label='Residuals for Power Law Fit', color='red')
